...
class Sector{//acá queda pendiente generalizar los métodos de carga de mapas 
    ...
    method posicionLibreRandom(){
        ...
        xs.forEach{x =>
            ys.forEach{y =>
                if( not Obstaculo.estaPresente(x,y)){
    ...
    method generarArmas(){
        ...
        cantidadArmas.times{
            ...
            var pos = self.posicionLibreRandom()
...
object sector1 inherits Sector{
   ...
   override method cargarEscena(){
    super()
    productorDeEscenas.renderizarCon(imgSalida.deComun(),ladoDerecho,sector4,self,game.at(10,5))
	productorDeEscenas.renderizarCon(imgSalida.deComun(),ladoIzquierdo,sector9,self,game.at(1,5))
...
object sector5 inherits Sector{
    override method cargarEscena(){
        super()
        productorDeEscenas.renderizarCon(imgSalida.deComun(),ladoIzquierdo,sector3,self,game.at(1,5))
        productorDeEscenas.renderizarHorizontal(11, paredSuperior,(1..10),self)
        productorDeEscenas.renderizarHorizontal(0, paredInferior,(1..10),self)
        productorDeEscenas.renderizarVertical(11, ladoDerecho,(1..10),self)
...
object sector6 inherits Sector{
    override method cargarEscena(){
        super()
        productorDeEscenas.renderizarCon(imgSalida.deComun(),ladoIzquierdo,sector4,self,game.at(1,5))
        productorDeEscenas.renderizarHorizontal(11, paredSuperior,(1..10),self)
        productorDeEscenas.renderizarHorizontal(0, paredInferior,(1..10),self)
        productorDeEscenas.renderizarVertical(11, ladoDerecho,(1..10),self)
...
object sector7 inherits Sector{
    override method cargarEscena(){
        ...
        productorDeEscenas.renderizarHorizontal(0, paredInferior,(1..10),self)
        productorDeEscenas.renderizarVertical(11, ladoDerecho,(1..10),self)
        productorDeEscenas.renderizarVertical(0, ladoIzquierdo,(1..10),self)
